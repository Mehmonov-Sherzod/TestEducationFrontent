...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    // Theme-aware button variants with blue accents
    const variants = {
      primary: isDark
        ? 'bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/30'
      ...
      secondary: isDark
        ? 'bg-[#1a1a1a] hover:bg-[#252525] text-white font-semibold'
        : 'bg-gray-100 hover:bg-gray-200 text-black font-semibold',
      outline: isDark
        ? 'border-2 border-gray-600/30 text-white hover:bg-[#1a1a1a]'
